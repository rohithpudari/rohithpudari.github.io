...
<a href="{{ '/assets/pdf/Pudari_Rohith_MSc_2022.pdf' | relative_url }}">
  ...
  <div class="col-12 col-md-6">
    ...
    <div class="d-flex align-items-start mb-3">
      ...
      <div style="padding-left:10px;">
        ...
        <a href="https://www.uvic.ca/index.php">University of Victoria</a> (2020 - 2022). <br>
        Advisor: <a href="https://neilernst.net">Prof. Neil Ernst</a>
      </div>
    </div>
    <div class="d-flex align-items-start mb-3">
